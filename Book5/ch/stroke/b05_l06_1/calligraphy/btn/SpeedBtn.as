...
{    
	...
	public class SpeedBtn extends BasicBtn
	{
		//設定私域變數
		...
		public function SpeedBtn()
		{
			...
			//取得此模式
			_mode = name.substring(name.lastIndexOf("_") + 1, name.length);
		}
		...
		override protected function clickFn(event:MouseEvent):void
		{
			...
			_singleton.dispatchEvent(new GeneralEvent(GeneralEvent.TOGGLE_STATUS, "Speed", _mode));			
			_sound.play();
			_timer.start();
		}
