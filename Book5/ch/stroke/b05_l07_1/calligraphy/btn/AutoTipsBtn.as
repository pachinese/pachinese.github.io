...
{    
	...
	public class AutoTipsBtn extends BasicBtn
	{
		//設定私域變數
		...
		{			
			if(!this.click)
				_singleton.dispatchEvent(new GeneralEvent(GeneralEvent.TOGGLE_STATUS, "AutoTips", "Show"));
			else
